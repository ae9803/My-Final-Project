...
angular.module('gservice', [])
    .factory('gservice', function($rootScope, $http){
        ...
        var selectedLat = 34.9224828;
        var selectedLong = -101.824597;
        ...
        var convertToMapPoints = function(response){
            ...
            for(var i= 0; i < response.length; i++) {
                ...
                var  contentString = '<p><b>Store Name</b>: ' + user.storename + '<br><b>Address</b>: ' + user.address + '<br>' +
        ...
        var Location = function(latlon, message, storename, address, phonenumber){
            this.latlon = latlon;
